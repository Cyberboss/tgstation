...
GLOBAL_VAR_INIT(service_requested_hard_restart, FALSE)	//if the world should request the service to kill it at reboot
GLOBAL_PROTECT(service_requested_hard_restart)